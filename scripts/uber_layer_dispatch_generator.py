...
# UberLayerDispatchGeneratorOptions - subclass of GeneratorOptions.
#
# Adds options used by UberLayerDispatchOutputGenerator objects during
# uber layer dispatch file generation.
#
# Additional members
...
class UberLayerDispatchGeneratorOptions(GeneratorOptions):
    def __init__(self,
                 filename = None,
                 directory = '.',
                 apiname = None,
...
# UberLayerDispatchOutputGenerator - subclass of OutputGenerator.
# Generates uber layer non-dispatchable handle-wrapping code.
#
# ---- methods ----
...
# genStruct()
# genType()
class UberLayerDispatchOutputGenerator(OutputGenerator):
    """Generate UniqueObjects code based on XML element attributes"""
    inline_copyright_message = """
// This file is ***GENERATED***.  Do Not Edit.
// See uber_layer_dispatch_generator.py for modifications.
...
"""
    ...
    def endFile(self):
        ...
        if not self.header:
            ...
            write('#include "uber_layer.h"', file=self.outFile)
            self.newline()
